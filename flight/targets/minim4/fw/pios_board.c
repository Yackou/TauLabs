...
void PIOS_Board_Init(void) {
	...
	if (boot_count < 3) {
		...
		HwMiniM4SetDefaults(HwMiniM4Handle(), 0);
	...
	HwMiniM4USB_VCPPortGet(&hw_usb_vcpport);

	if (!usb_cdc_present) {
		/* Force VCP port function to disabled if we haven't advertised VCP in our USB descriptor */
		hw_usb_vcpport = HWMINIM4_USB_VCPPORT_DISABLED;
	}
	...
	case HWMINIM4_USB_VCPPORT_DISABLED:
		break;
	case HWMINIM4_USB_VCPPORT_USBTELEMETRY:
		...
		break;
	case HWMINIM4_USB_VCPPORT_COMBRIDGE:
#if defined(PIOS_INCLUDE_COM)
		{
...
#endif	/* PIOS_INCLUDE_COM */
		break;
	case HWMINIM4_USB_VCPPORT_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_COM)
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE)
		{
	...
	HwMiniM4USB_HIDPortGet(&hw_usb_hidport);

	if (!usb_hid_present) {
		/* Force HID port function to disabled if we haven't advertised HID in our USB descriptor */
		hw_usb_hidport = HWMINIM4_USB_HIDPORT_DISABLED;
	}
	...
	case HWMINIM4_USB_HIDPORT_DISABLED:
		break;
	case HWMINIM4_USB_HIDPORT_USBTELEMETRY:
#if defined(PIOS_INCLUDE_COM)
		{
			uint8_t * rx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_RX_BUF_LEN);
			uint8_t * tx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_TX_BUF_LEN);
	...
	uint8_t hw_DSMxBind;
	HwMiniM4DSMxBindGet(&hw_DSMxBind);
	...
	/* UART1 Port */
	uint8_t hw_uart1;
	HwMiniM4Uart1Get(&hw_uart1);
	switch (hw_uart1) {
	case HWMINIM4_UART1_DISABLED:
		break;
	case HWMINIM4_UART1_TELEMETRY:
	...
	case HWMINIM4_UART1_I2C:
...
#if defined(PIOS_INCLUDE_HMC5883)
		{
			...
			HwMiniM4MagnetometerGet(&Magnetometer);

			if (Magnetometer == HWMINIM4_MAGNETOMETER_EXTERNALI2CUART1) {
				// init sensor
		...
		break;
	case HWMINIM4_UART1_DSM2:
	case HWMINIM4_UART1_DSMX10BIT:
	case HWMINIM4_UART1_DSMX11BIT:
		...
		break;
	case HWMINIM4_UART1_HOTTSUMD:
	case HWMINIM4_UART1_HOTTSUMH:
		...
		break;
	case HWMINIM4_UART1_DEBUGCONSOLE:
	...
	case HWMINIM4_UART1_MAVLINKTX:
		...
		break;
	case HWMINIM4_UART1_MAVLINKTX_GPS_RX:
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWMINIM4_UART1_HOTTTELEMETRY:
		...
		break;
	case HWMINIM4_UART1_FRSKYSENSORHUB:
	...
	/* UART2 Port */
	uint8_t hw_uart2;
	HwMiniM4Uart2Get(&hw_uart2);
	switch (hw_uart2) {
	case HWMINIM4_UART2_DISABLED:
		break;
	case HWMINIM4_UART2_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	case HWMINIM4_UART2_SBUS:
		...
		break;
	case HWMINIM4_UART2_DSM2:
	case HWMINIM4_UART2_DSMX10BIT:
	case HWMINIM4_UART2_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart2) {
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWMINIM4_UART2_HOTTSUMD:
	case HWMINIM4_UART2_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart2) {
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWMINIM4_UART2_HOTTTELEMETRY:
#if defined(PIOS_INCLUDE_HOTT) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif /* PIOS_INCLUDE_HOTT */
		break;
	case HWMINIM4_UART2_FRSKYSENSORHUB:
#if defined(PIOS_INCLUDE_FRSKY_SENSOR_HUB) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	/* UART3 Port */
	uint8_t hw_uart3;
	HwMiniM4Uart3Get(&hw_uart3);
	switch (hw_uart3) {
	case HWMINIM4_UART3_DISABLED:
		break;
	case HWMINIM4_UART3_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	case HWMINIM4_UART3_I2C:
...
#if defined(PIOS_INCLUDE_HMC5883)
		{
			...
			if (Magnetometer == HWMINIM4_MAGNETOMETER_EXTERNALI2CUART3) {
				// init sensor
...
#endif	/* PIOS_INCLUDE_I2C */
		break;
	case HWMINIM4_UART3_DSM2:
	case HWMINIM4_UART3_DSMX10BIT:
	case HWMINIM4_UART3_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart3) {
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWMINIM4_UART3_HOTTSUMD:
	case HWMINIM4_UART3_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart3) {
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWMINIM4_UART3_HOTTTELEMETRY:
#if defined(PIOS_INCLUDE_HOTT) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	/* UART4 Port */
	uint8_t hw_uart4;
	HwMiniM4Uart4Get(&hw_uart4);
	switch (hw_uart4) {
	case HWMINIM4_UART4_DISABLED:
		break;
	case HWMINIM4_UART4_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWMINIM4_UART4_DSM2:
	case HWMINIM4_UART4_DSMX10BIT:
	case HWMINIM4_UART4_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart4) {
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWMINIM4_UART4_HOTTSUMD:
	case HWMINIM4_UART4_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart4) {
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWMINIM4_UART4_HOTTTELEMETRY:
#if defined(PIOS_INCLUDE_HOTT) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif /* PIOS_INCLUDE_HOTT */
		break;
	case HWMINIM4_UART4_FRSKYSENSORHUB:
#if defined(PIOS_INCLUDE_FRSKY_SENSOR_HUB) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	/* UART5 Port */
	uint8_t hw_uart5;
	HwMiniM4Uart5Get(&hw_uart5);
	switch (hw_uart5) {
	case HWMINIM4_UART5_DISABLED:
		break;
	case HWMINIM4_UART5_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWMINIM4_UART5_DSM2:
	case HWMINIM4_UART5_DSMX10BIT:
	case HWMINIM4_UART5_DSMX11BIT:
#if defined(PIOS_INCLUDE_DSM)
		{
			enum pios_dsm_proto proto;
			switch (hw_uart5) {
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWMINIM4_UART5_HOTTSUMD:
	case HWMINIM4_UART5_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart5) {
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWMINIM4_UART5_HOTTTELEMETRY:
#if defined(PIOS_INCLUDE_HOTT) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif /* PIOS_INCLUDE_HOTT */
		break;
	case HWMINIM4_UART5_FRSKYSENSORHUB:
#if defined(PIOS_INCLUDE_FRSKY_SENSOR_HUB) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	uint8_t hw_rcvrport;
	HwMiniM4RcvrPortGet(&hw_rcvrport);

	switch (hw_rcvrport) {
	case HWMINIM4_RCVRPORT_DISABLED:
		break;
	case HWMINIM4_RCVRPORT_PWM:
...
#endif	/* PIOS_INCLUDE_PWM */
		break;
	case HWMINIM4_RCVRPORT_PPM:
	case HWMINIM4_RCVRPORT_PPMADC:
	case HWMINIM4_RCVRPORT_PPMOUTPUTS:
	case HWMINIM4_RCVRPORT_PPMOUTPUTSADC:
...
#endif	/* PIOS_INCLUDE_PWM */
		break;
	case HWMINIM4_RCVRPORT_PPMPWMADC:
	...
	switch (hw_rcvrport) {
		...
		case HWMINIM4_RCVRPORT_PPMPWMADC:
			...
			break;
		case HWMINIM4_RCVRPORT_PPMOUTPUTS:
		case HWMINIM4_RCVRPORT_OUTPUTS:
#ifdef PIOS_INCLUDE_SERVO
			PIOS_Servo_Init(&pios_servo_with_rcvr_cfg);
#endif
			break;
		case HWMINIM4_RCVRPORT_PPMOUTPUTSADC:
		case HWMINIM4_RCVRPORT_OUTPUTSADC:
#ifdef PIOS_INCLUDE_SERVO
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		if (Magnetometer == HWMINIM4_MAGNETOMETER_INTERNAL) {
		...
		if (Magnetometer == HWMINIM4_MAGNETOMETER_EXTERNALI2CUART1 ||
			Magnetometer == HWMINIM4_MAGNETOMETER_EXTERNALI2CUART3)
		{
			// setup sensor orientation
			uint8_t ExtMagOrientation;
			HwMiniM4ExtMagOrientationGet(&ExtMagOrientation);

			enum pios_hmc5883_orientation hmc5883_orientation = \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_TOP0DEGCW) ? PIOS_HMC5883_TOP_0DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_TOP90DEGCW) ? PIOS_HMC5883_TOP_90DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_TOP180DEGCW) ? PIOS_HMC5883_TOP_180DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_TOP270DEGCW) ? PIOS_HMC5883_TOP_270DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_BOTTOM0DEGCW) ? PIOS_HMC5883_BOTTOM_0DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_BOTTOM90DEGCW) ? PIOS_HMC5883_BOTTOM_90DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
				(ExtMagOrientation == HWMINIM4_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
	...
	if (hw_rcvrport == HWMINIM4_RCVRPORT_PWMADC ||
			hw_rcvrport == HWMINIM4_RCVRPORT_PPMADC ||
			hw_rcvrport == HWMINIM4_RCVRPORT_PPMPWMADC ||
			hw_rcvrport == HWMINIM4_RCVRPORT_OUTPUTSADC ||
			hw_rcvrport == HWMINIM4_RCVRPORT_PPMOUTPUTSADC) {
